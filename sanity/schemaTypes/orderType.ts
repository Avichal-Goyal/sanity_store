...
export const orderType = defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            group: "details",
            readOnly: true,
            description: "Total order amountin GBP",
        }),
        defineField({
            name: "status",
            type: "string",
        ...
        defineField({
            ...
            fields: [
                ...
                defineField({ name: "line1", type: "string", title: "Addredd Line 1" }),
                defineField({ name: "line2", type: "string", title: "Addredd Line 2" }),
